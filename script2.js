    ...
    function initSections() {
        ...
        sections.forEach(section => {
            section.addEventListener('click', function () {
                const currentSection = parseInt(section.getAttribute('data-section'));
                startQuiz(currentSection);
            });
        });
    }

    function startQuiz(currentSection) {
        let currentQuestions = shuffleArray(quizData.sections[currentSection].questions);
        ...
        questionContainer.innerHTML = `<p id="score">Score: 0</p>
                                       <p id="timer">Time remaining: ${timeLimit} seconds</p>
                                       <div id="question"></div>
                                       <div id="options"></div>
        ...
        function handleTimeUp() {
            checkAnswer('', currentQuestions[currentQuestionIndex].answer);
        }
